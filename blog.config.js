...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是Hemon,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'hemon', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '吃肉全对神', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://hemonn.com', // 网站地址
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/Hemonn', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/teabag.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  FACEBOOK_PAGE_ID: process.env.NEXT_PUBLIC_FACEBOOK_PAGE_ID || '200863039786662', // Facebook Page ID 來啟用 messenger 聊天功能
  FACEBOOK_APP_ID: process.env.NEXT_PUBLIC_FACEBOOK_APP_ID || '340287882347931', // Facebook App ID 來啟用 messenger 聊天功能 获取: https://developers.facebook.com/
  ...
  // 音乐播放插件
  MUSIC_PLAYER: process.env.NEXT_PUBLIC_MUSIC_PLAYER || true,//false, // 是否使用音乐播放插件
